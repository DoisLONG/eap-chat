  ...
  <div class="exam-management">
    ...
    <el-card class="list-card">
      ...
      <el-table ref="tableRef" class="exam-table" border v-loading="loading" :data="rows" row-key="id" :empty-text="t('SopPicker.noData')" @selection-change="selectedRows = $event">
        ...
        <el-table-column :label="t('exam.category')" min-width="150" align="center" header-align="center"><template #default="{ row }"><div class="table-cell-center"><el-tooltip :content="categoryText(row)" placement="top"><el-tag size="small" effect="plain" :class="categoryClass(row.exam_type === 'mixed' ? '混合' : row.primary_category_name)"><span class="ellipsis category-text">{{ categoryText(row) }}</span></el-tag></el-tooltip></div></template></el-table-column>
