export default {
  ...
  questionBank: {
    ...
    allOperation: "All operations",
    allTechnology: "All technology",
    companyCharter: "Company Charter",
    keywordPlaceholder: "Enter question keywords",
    ...
    deleteMessage: "Delete the selected {count} question(s)?",
    deleteSuccess: "Deleted {count} question(s)",
  },
  evaluation: {
    filterTitle: "Evaluation Filters",
    listTitle: "Results",
    ...
    submitAndDuration: "Submitted and duration",
    answerSummary: "Answer summary",
    summary: "Correct {correct} · Wrong {wrong} · Unanswered {unanswered}",
    answerDetails: "Answer details",
    employeeAnswer: "Employee answer",
    referenceAnswer: "Reference answer",
    unanswered: "Unanswered",
    questionScore: "Score {score} / {points}",
    noAnswerDetails: "No answer details available.",
    choice: "Multiple choice",
    essay: "Open question",
    deleteTitle: "Confirm deletion",
    deleteMessage: "Delete the selected {count} result record(s)?",
    deleteSuccess: "Deleted {count} result record(s)",
  },
  licenseAdmin: {
    sopManagement: "SOP Management",
